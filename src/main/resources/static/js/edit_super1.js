	...
	var edit = {
		...
		tabEdit:function(){
			...
			if(levelId == 2){
				...
				//方案基本信息
				var schemeMsg = '<li class="first_info" id="'+projectinfos.projectId+'"><div class="d_info">方案名称：<span>'+projectinfos.projectName+'</span></div><div class="d_info">方案code：<span>'+projectinfos.projectCode+'</span></div></li>';
				...
				//渠道基本信息
				var schemeMsg = '<li class="first_info" id="'+infos.dataSourceId+'"><div class="d_info">渠道名称：<span>'+infos.sourceName+'</span></div><div class="d_info">渠道code：<span>'+infos.dataSource+'</span></div></li>';
				$("#scheme_msg").append(schemeMsg);
...
//				break;
				...
				case "#server_msg":
					tabTr ='<li class="li_info">'+
						'<div class="d_info"><span class="span_title">接口类型：</span><select id="requestType_a" name="requestType"class="selectWidth" ></select></div>'+
