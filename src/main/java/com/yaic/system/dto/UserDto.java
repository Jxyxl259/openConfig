...
@ApiModel(value = "UserDto", description = "登录用户数据传输DTO")
public class UserDto extends BaseDto{
    ...
    public void setPasswordSetDate(String passwordSetDate) {
        this.passwordSetDate = TimeUtil.parseDate(passwordSetDate, DateTime.YEAR_TO_SECOND);
    }
    ...
    public void setPasswordExpireDate(String passwordExpireDate) {
        this.passwordExpireDate = TimeUtil.parseDate(passwordExpireDate, DateTime.YEAR_TO_SECOND);
    }
